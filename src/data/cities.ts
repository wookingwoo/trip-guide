...
export const cities: Record<string, City> = {
  sapporo: {
    ...
    attractions: [
      ...
      },
      {
        ...
        image: "/images/hokkaido-shrine.jpg",
      },
      {
    ...
    foods: [
      ...
      {
        name: "Kaisendon",
        description: "A rice bowl topped generously with fresh seafood.",
        image: "/images/kaisendon.jpg",
      },
      {
        name: "Soft Serve Ice Cream",
        description: "Rich and smooth ice cream made from fresh Hokkaido milk.",
        image: "/images/soft-serve.jpg",
      },
    ],
    tips: [
      "Wear non-slip shoes in winter as it snows heavily.",
      "Book accommodation in advance during the Snow Festival in February.",
      "Use the well-developed underground walkways for convenient travel.",
    ],
    bestTime:
      "February for the Snow Festival, July-August for flowers and cool weather.",
  },
  shizuoka: {
    id: "shizuoka",
    name: "Shizuoka",
    ...
    image: "/images/shizuoka-hero.svg",
    attractions: [
      {
    ...
    foods: [
      {
        ...
        image: "/images/shizuoka-food.svg",
      },
      {
        name: "Shimizu Port Tuna",
        description:
      ...
      {
        name: "Shizuoka Tea and Tea Sweets",
        description:
  ...
  fuji: {
    ...
    image: "/images/fuji-hero.svg",
    attractions: [
      {
        name: "Obuchi Sasaba Tea Fields",
        description:
      ...
      {
        name: "Fujinokuni Tagonoura Port Park",
        description:
      ...
      {
        name: "Mt. Fuji and Princess Kaguya Museum",
        description:
      ...
      {
        name: "Factory Night View and the Gakunan Railway Area",
        description:
    ...
    foods: [
      {
        ...
        image: "/images/fuji-food.svg",
      },
      {
        name: "Tsuke Napolitan",
        description:
      ...
      {
        name: "Fuji Tea and Tea Desserts",
        description:
      ...
      {
        name: "Mt. Fuji Spring-Water Drinks and Sake",
        description:
    ...
    attractions: [
      {
        ...
        description:
          "Tokyo's most famous temple district pairs historic gates, incense, and lanterns with a lively shopping street full of traditional snacks and souvenirs.",
        image: "/images/tokyo-hero.svg",
      },
      {
        name: "Meiji Jingu",
        description:
          "A spacious forested shrine complex near Harajuku that feels surprisingly calm despite its central location. It is one of the best places to experience Tokyo's spiritual side.",
        image: "/images/tokyo-hero.svg",
      },
      {
        name: "Shibuya Scramble Crossing and Center-Gai",
        description:
          "The icon of modern Tokyo street energy: giant screens, youth culture, nonstop foot traffic, late-night dining, and easy access to shopping and viewpoints.",
        image: "/images/tokyo-hero.svg",
      },
      {
        name: "Tokyo Skytree",
        description:
          "A modern symbol of the city with huge panoramic views, shopping, dining, and easy connections to the older eastern districts around Asakusa.",
        image: "/images/tokyo-hero.svg",
      },
      {
    ...
    foods: [
      {
        name: "Edomae Sushi",
        description:
          "Traditional Tokyo-style sushi rooted in Edo-era techniques. It ranges from quick standing counters to refined omakase, but the core idea is balance between seasoned rice and carefully prepared seafood.",
        image: "/images/tokyo-food.svg",
      },
      {
        name: "Monjayaki",
        description:
          "Tokyo's famous griddled batter dish, best experienced in Tsukishima where entire streets specialize in it. It is messy, social, and fun rather than formal.",
        image: "/images/tokyo-food.svg",
      },
      {
        name: "Tempura",
        description:
          "Crisp seafood and vegetables fried lightly enough to highlight ingredient quality. Tokyo remains one of the best places in Japan to try both classic and high-end tempura.",
        image: "/images/tokyo-food.svg",
      },
      {
        name: "Tokyo Ramen",
        description:
          "The city offers every style imaginable, but classic shoyu ramen and countless neighborhood specialties make Tokyo one of the world's best places for casual noodle hunting.",
        image: "/images/tokyo-food.svg",
      },
      {
        name: "Fukagawa-meshi",
        description:
          "A historic downtown dish of rice and clams associated with Tokyo's old waterfront working neighborhoods, especially around Fukagawa.",
        image: "/images/tokyo-food.svg",
      },
      {
        name: "Ningyo-yaki and Asakusa Sweets",
        description:
          "Small sponge cakes and old-school snacks around Asakusa are easy local treats between sightseeing stops.",
        image: "/images/tokyo-food.svg",
      },
    ],
    tips: [
      "Use a Suica or PASMO-compatible IC card and rely on rail first; taxis are useful late at night but much slower and more expensive in busy areas.",
      "Avoid major commuter rush periods if you can, especially weekday mornings and early evenings.",
      "Tokyo rewards neighborhood-based planning, so group nearby areas such as Asakusa and Skytree or Harajuku and Shibuya on the same day.",
      "Popular museums, observation decks, themed cafes, and special exhibitions often need advance reservations.",
      "Last trains can be earlier than visitors expect after a late dinner or bar crawl, so check the return route before midnight.",
      "Comfortable shoes matter more than almost anything else; even train-focused itineraries usually involve long station walks.",
      "Keep a small amount of cash despite Tokyo's improving card acceptance, especially for shrines, tiny eateries, and older shops.",
    ],
    bestTime:
      "Late March to May and October to November are the easiest seasons for long city walks, while winter offers crisp air, illuminations, and comparatively clear views from observation decks.",
  },
  rome: {
    id: "rome",
    name: "Rome",
    ...
    foods: [
      ...
      },
      {
        ...
        image: "/images/pizza-al-taglio.jpg",
      },
      {
        name: "Tiramisu",
        description:
    ...
    tips: [
      "Booking tickets for the Colosseum and Vatican Museums in advance is essential.",
      "Note that restaurants often charge for water.",
      "Beware of pickpockets and keep your bag in front of you.",
    ],
    bestTime:
      "Spring (April-May) or Autumn (September-October) are the best times to travel for mild weather.",
  },
  bangkok: {
    id: "bangkok",
    name: "Bangkok",
